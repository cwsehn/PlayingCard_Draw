...
//  PlayingCard_Draw
//
//  Created by Chris William Sehnert on 12/28/17.
...
class PlayingCardView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if isFaceUp {
            ...
            if let cardBackImage = UIImage(named: "cardBackImage", in: Bundle(for: self.classForCoder), compatibleWith: traitCollection) {
